...
export default function Parcours() {
    return (
        <div className="parcours">
            <h1>Mon parcours</h1>
            <h2>personnel et professionnel</h2>
            <div className="text">
                <p>
                ...
                <p>
                    ...
                    pas.
                    <br /> Nous décidons de déménager de Colomiers vers Albi (je
                ...
                <p>
                    ...
                    destination d’enfants trisomiques.
                    <br /> La directrice de l’école dans laquelle sont
                    scolarisés mes enfants me prête les locaux de l’école (je ne
                    la remercierai jamais assez) pour mon activité qui se
                    déroule le mercredi. Le reste de la semaine, je l’occupe en
                    donnant un coup de main à l’école (surveillance pendant les
                    temps de repas et de garderie).
                    <br /> Lorsqu’une collègue tombe malade, la directrice me
                    propose de m’embaucher au sein de l’école et c’est le départ
                ...
                <p>
                    ...
                    départ.
                    <br /> L’évidence s’impose clairement à moi : puisque j’ai
                ...
                <p>
                    ...
                    OpenClassrooms le 1er juillet 2022.
                    <br /> Finalement, après quelques frayeurs pour avoir pris
                    un peu de retard sur un projet, je vais pouvoir terminer ma
                    formation avec une semaine d’avance sur le programme prévu,
                    le 21 février.
                </p>
                <p>
